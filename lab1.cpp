...
int main() {
	...
	for (int i = 1; i < numberOfValues; i++){
		...
		valuesFunction[i] = Euler.ValuesOfX(100, stepOfPointTimeGrid[i]);
	}

	Euler.makeFileForGraph(stepOfPointTimeGrid, valuesFunction, "1.2.dat");
	Euler.drawGraph("1.2.dat", "Values");
